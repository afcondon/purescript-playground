...
"""
  , cells:
      ...
      , { id: "c3", kind: "expr"
        , source:
            """{ globalDensity: globalDensity, densestFive: Array.take 5 (Array.sortBy (\a b -> compare (b.population / b.areaKm2) (a.population / a.areaKm2)) countries), sparsestFive: Array.take 5 (Array.sortBy (\a b -> compare (a.population / a.areaKm2) (b.population / b.areaKm2)) countries) }"""
        }
      , { id: "c4", kind: "expr"
        , source:
            """colouredSvg"""
