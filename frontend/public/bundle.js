...
(() => {
  ...
  var render = function(v) {
    ...
    return div2([class_("playground-shell")])([header([class_("playground-header")])([h1_([text5("PureScript Playground")]), p([class_("subtitle")])([text5("A scratchpad with live re-evaluation \u2014 scaffolding only.")])]), main([class_("columns")])([paneStub("module")("Module")("User module goes here."), paneStub("playground")("Cells")("Playground cells go here."), paneStub("gutter")("Gutter")("Values and types will render here.")])]);
  };
